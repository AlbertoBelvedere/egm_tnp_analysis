...
baseOutDir = 'results/Run3_postleak_new_lowMBX_notrigMVA/tnpEleID/'
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/ec/nkasarag/EGM_comm/PU/EFG_2022/mcRun3_130X_2022_realistic_postEE_ele_69p2mb.pu.puTree.root')
...
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/ec/nkasarag/EGM_comm/PU/EFG_2022/mcRun3_130X_2022_realistic_postEE_ele_69p2mb.pu.puTree.root')
