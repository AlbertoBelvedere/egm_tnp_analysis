...
baseOutDir = 'results/2023_pre/tnpEleID/'
...
samplesDef = {
    'data'   : tnpSamples.Run3_2023_pre['data_2023'].clone(),
    'mcNom'  : tnpSamples.Run3_2023_pre['DY_amcatnlo'].clone(),
    'mcAlt'  : tnpSamples.Run3_2023_pre['DY_madgraph'].clone(),
    'tagSel' : tnpSamples.Run3_2023_pre['DY_amcatnlo'].clone(),
}
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 33 && abs(tag_sc_eta) < 2.17 && el_q*tag_Ele_q < 0'
...
tnpParNomFit = [
    ...
    "meanF[-0.0,-5.0,5.0]","sigmaF[0.9,0,5.0]",
    "acmsP[60.,30.,100.]","betaP[0.05,0.001,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[60.,30,80.]","betaF[0.05,0.001,0.12]","gammaF[0.025]","peakF[90.0]",
    ]
