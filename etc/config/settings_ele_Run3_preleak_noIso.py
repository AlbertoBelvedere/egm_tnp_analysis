...
baseOutDir = 'results/Run3_preleak_noIso/tnpEleID/'
...
samplesDef = {
    'data'   : tnpSamples.Run3_preleak_noIso['data_Run3BCD'].clone(),
    'mcNom'  : tnpSamples.Run3_preleak_noIso['DY_madgraph'].clone(),
    'mcAlt'  : None,
    'tagSel' : tnpSamples.Run3_preleak_noIso['DY_madgraph'].clone(),
}
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/abelvede/pileupReweightingFiles/preEE/DY_powheg_ele.pu.puTree.root')
...
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/abelvede/pileupReweightingFiles/preEE/DY_powheg_ele.pu.puTree.root')
...
tnpParNomFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.1,5.0]",
    "meanF[-0.1,-5.0,5.0]","sigmaF[0.9,0,5.0]",
    "acmsP[60.,30.,100.]","betaP[0.05,0.001,0.08]","gammaP[-0.017]","peakP[90.0]",
    "acmsF[60.,30.,80.]","betaF[0.05,0.001,0.12]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
...
tnpParAltSigFit100500 = [
    ...
    "acmsP[75.,50.,250.]","betaP[0.06,0.01,0.06]","gammaP[0.005, 0., 1]","peakP[90.0]",
    "acmsF[75.,50.,250.]","betaF[0.06,0.01,0.06]","gammaF[0.005, 0., 0.1]","peakF[90.0]",
    ]
