...
baseOutDir = 'results/Run3_postleak_noIso/tnpEleID/'
...
samplesDef = {
    'data'   : tnpSamples.Run3_postleak_noIso['data_Run3EFG'].clone(),
    'mcNom'  : tnpSamples.Run3_postleak_noIso['DY_madgraph'].clone(),
    'mcAlt'  : None,
    'tagSel' : tnpSamples.Run3_postleak_noIso['DY_madgraph'].clone(),
}
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/abelvede/pileupReweightingFiles/postEE/DY_powheg_ele.pu.puTree.root')
...
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/abelvede/pileupReweightingFiles/postEE/DY_powheg_ele.pu.puTree.root')
...
tnpParNomFit = [
    ...
    "meanF[-0.0,-3.0,5.0]","sigmaF[0.9,0,5.0]",
...
tnpParAltSigFit3550 = [
    ...
    "meanF[0.0, -2.,2.5]","sigmaF[2,0.1,3.0]","alphaF[1.0,0,2.]",'nF[0.75,0.1,1.5]',"sigmaF_2[2.,0.1,2.0]","sosF[1,0.01,5.0]",
...
tnpParAltSigFit50100 = [
    ...
    "meanF[1.0, 0.1,2.5]","sigmaF[1.5,0.1,2.0]","alphaF[-0.8,-1.5,0.5]",'nF[0.75,0.1,1.5]',"sigmaF_2[2.,0.1,2.0]","sosF[1,0.01,5.0]",
...
tnpParAltBkgFit = [
    ...
    "meanF[-0.0,-1.5,5.0]","sigmaF[0.9,0.5,5.0]",
    "alphaP[0.,-5.,5.]",
    "alphaF[0.,-5.,5.]",
    ]
