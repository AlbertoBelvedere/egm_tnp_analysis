...
baseOutDir = 'results/Run3_preleak_altSig/tnpEleID/'
...
#    ]
tnpParAltSigFit = [
    "meanP[-1.0, -2,2.5]","sigmaP[1.5,0.1,3.0]","alphaP[-2.0,-3,0.5]" ,'nP[0.75,0.1,1.5]',"sigmaP_2[1.5,0.1,2.0]","sosP[1,0.01,5.0]",
    "meanF[-1.0, -3,2.5]","sigmaF[2,0.1,3.0]","alphaF[-2.0,-3,0.5]",'nF[0.75,0.1,1.5]',"sigmaF_2[2.,0.1,2.0]","sosF[1,0.01,2.0]",
    "acmsP[60.,50.,250.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    "acmsF[60.,50.,250.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 0.5]","peakF[90.0]",
    ]
